<template>
  <div>
    <div>
      ...
      <el-button type="primary" size="small" @click="searchList" id="searchButton" style="margin-left:20px" icon="el-icon-search">
      </el-button>
      <!-- addForm -->
      <el-button  type="primary" @click="state.addShow=true"  size="small" style="margin-left:10px"  icon="el-icon-plus"></el-button>
