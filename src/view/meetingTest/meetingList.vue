  ...
  <div>
    <div>
      ...
      <el-dialog title="增加会议" :visible.sync="addFormStatus" width="540px">
        <add ref="addForm" v-bind:departments="departments" @addFormChange="addFormChange" @message="message"
             @refresh="refresh"></add>
      </el-dialog>
      <!-- treeForm============================================== -->
      ...
      <el-dialog title="增加会议" :visible.sync="treeAddFormStatus" width="540px">
        <treeAdd ref="treeAddForm" v-bind:departments="departments" @treeAddFormChange="treeAddFormChange"
                 @message="message" @refresh="refresh"></treeAdd>
      </el-dialog>
      <!-- ///////////////////treeForm============================================== -->
    </div>
